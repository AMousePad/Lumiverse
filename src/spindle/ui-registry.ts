...
export const BUILT_IN_SETTINGS_TABS: readonly SpindleUISettingsTabEntry[] = [
  ...
  { id: "webSearch", shortName: "Web Search", tabName: "Web Search", tabDescription: "Configure SearXNG or Exa web search for council tools", keywords: ["web search", "searxng", "exa", "search", "browse", "internet", "web", "council tool"] },
